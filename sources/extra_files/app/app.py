...
def _derniere_activite(patient):
    ...
    d, m, prat, cab = items[0]
    return {'date': d, 'motif': m, 'praticien': prat, 'cabinet': cab}
...
BUILTIN_SECTIONS = [
    ...
    ('acuite','Acuité visuelle',[
        ('av_bino','Binoculaire','select',['10/10','9/10','8/10','7/10','6/10','5/10','4/10','3/10','2/10','1/10']),
        ('av_correction','Correction','select',['sans correction','avec correction habituelle','avec correction optimale','avec addition']),
        ('av_od_loin','OD de loin','select',['10/10','9/10','8/10','7/10','6/10','5/10','4/10','3/10','2/10','1/10']),
        ('av_od_pres','OD de près','select',['P2','P3','P4','P5','P6','P8','P10','P14']),
        ('av_og_loin','OG de loin','select',['10/10','9/10','8/10','7/10','6/10','5/10','4/10','3/10','2/10','1/10']),
        ('av_og_pres','OG de près','select',['P2','P3','P4','P5','P6','P8','P10','P14'])]),
    ...
    ('refraction_subj','Réfraction subjective',[('od_sph','OD sphère','sph',[]),('od_cyl','OD cylindre','text',[]),('od_axe','OD axe','number',[]),('od_add','Add OD','number',[]),('og_sph','OG sphère','sph',[]),('og_cyl','OG cylindre','text',[]),('og_axe','OG axe','number',[]),('og_add','Add OG','number',[]),
        ('od_av_loin','AV OD de loin','select',['10/10','9/10','8/10','7/10','6/10','5/10','4/10','3/10','2/10','1/10']),
        ('od_av_pres','AV OD de près','select',['P2','P3','P4','P5','P6','P8','P10','P14']),
        ('og_av_loin','AV OG de loin','select',['10/10','9/10','8/10','7/10','6/10','5/10','4/10','3/10','2/10','1/10']),
        ('og_av_pres','AV OG de près','select',['P2','P3','P4','P5','P6','P8','P10','P14'])]),
